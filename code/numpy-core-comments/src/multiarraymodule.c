...
/* $Id: multiarraymodule.c,v 1.3 2009/01/07 11:37:31 marquard Exp $ */
                 ...
                 PyArrayObject *ret, NPY_CLIPMODE clipmode)
{
	...
	//PyArray_ContigousFromAny does this (quote):
	//"returns a (C-style) contiguous and behaved function array from any nested sequence or array
	//interface exporting object, op, of (non-flexible) type given by the enumerated typenum, of 
	//minimum depth min_depth, and of maximum depth max_depth."
	//
	//Defined as follows in ndarrayobject.h:
	//#define PyArray_ContiguousFromAny(op, type, min_depth, max_depth)             \
        //PyArray_FromAny(op, PyArray_DescrFromType(type), min_depth,           \
        //max_depth, NPY_DEFAULT, NULL)
	//
	//PyArray_FromAny is defined in arrayobject.c and is commented already :-)
	//
	//The call can result in a memcpy call on the data parts (eg. call to PyArray_FromArray with set usecopy to true)
