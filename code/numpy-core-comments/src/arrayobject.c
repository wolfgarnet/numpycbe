...
PyArray_FillWithScalar(PyArrayObject *arr, PyObject *obj)
{
	...
	//f points to a table of functions supplied with each type (basic data descriptor)
...
/* W: transforms a numpy python structure to cobject. See Python/Objects/cobject.c. I have
   not figured out what this is good for. */
...
/* W: This is the gettes and setters of the nd-array! */
...
/* This is the type object for the nd-array. */
