...
#include <libspe2.h>
#include "Python.h"
#include "/home/jens/python/numpy-1.2.1/numpy/core/include/numpy/arrayobject.h"


//Called with e.g.: take(A,[],0) in Python.
static PyObject *
array_take(PyArrayObject *self, PyObject *args, PyObject *kwds)
{
	printf("arraymethods::array_take(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
...
{
printf("arraymethods::array_fill(PyArrayObject *self, PyObject *args)\n");
    PyObject *obj;
...
{
printf("arraymethods::array_put(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
...
{
printf("arraymethods::array_reshape(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
...
{
printf("arraymethods::array_squeeze(PyArrayObject *self, PyObject *args)\n");
...
{
printf("arraymethods::array_view(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
...
{
printf("arraymethods::array_argmax(PyArrayObject *self, PyObject *args, PyObject *kwds)");
    int axis=MAX_DIMS;
    PyArrayObject *out=NULL;
...
{
printf("arraymethods::array_argmin(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArrayObject *out=NULL;
    static char *kwlist[] = {"axis", "out", NULL};
...
{
printf("arraymethods::array_max(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArrayObject *out=NULL;
    static char *kwlist[] = {"axis", "out", NULL};
...
{
printf("arraymethods::array_ptp(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArrayObject *out=NULL;
    static char *kwlist[] = {"axis", "out", NULL};
...
{
printf("arraymethods::array_min(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArrayObject *out=NULL;
    static char *kwlist[] = {"axis", "out", NULL};
...
{
printf("arraymethods::array_swapaxes(PyArrayObject *self, PyObject *args)\n");
    int axis1, axis2;
...
{
	printf("arraymethods::PyArray_GetField(PyArrayObject *self, PyArray_Descr *typed, int offset)\n");
    PyObject *ret=NULL;
...
{
printf("arraymethods::array_getfield(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
...
{
printf("arraymethods::yArray_SetField(PyArrayObject *self, PyArray_Descr *dtype, int offset, PyObject *val)\n");
    PyObject *ret=NULL;
    int retval = 0;
...
{
printf("arraymethods::array_setfield(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    PyArray_Descr *dtype=NULL;
    int offset = 0;
    PyObject *value;
...
{
printf("arraymethods::PyArray_Byteswap(PyArrayObject *self, Bool inplace)\n");
    PyArrayObject *ret;
    intp size;
...
{
printf("arraymethods::array_byteswap(PyArrayObject *self, PyObject *args)\n");
    Bool inplace=FALSE;
...
{
printf("arraymethods::array_tolist(PyArrayObject *self, PyObject *args)\n");
    if (!PyArg_ParseTuple(args, "")) return NULL;
...
{
printf("arraymethods::array_tostring(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
...
{
printf("callfunction arraymethods::array_tofile(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int ret;
    PyObject *file;
    FILE *fd;
    char *sep="";
...
array_toscalar(PyArrayObject *self, PyObject *args) {
  printf("arraymethods::array_toscalar(PyArrayObject *self, PyObject *args)\n");
  printf("Printing PyArrayObject 1:\n");
  printf("data[3] unsigned int = %d\n",(unsigned int*)(self->data)[3]);//second 32 bit
  printf("data[7] unsigned int = %d\n",(unsigned int*)(self->data)[7]);//first 32 bit
  printf("data[11] unsigned int = %d\n",(unsigned int*)(self->data)[11]);//second 32 bit
  printf("data[15] unsigned int = %d\n",(unsigned int*)(self->data)[15]);//first 32 bit
  printf("data[19] unsigned int = %d\n",(unsigned int*)(self->data)[19]);//second 32 bit
  printf("data[23] unsigned int = %d\n",(unsigned int*)(self->data)[23]);//first 32 bit
  printf("data[27] unsigned int = %d\n",(unsigned int*)(self->data)[27]);//second 32 bit
  printf("data[31] unsigned int = %d\n",(unsigned int*)(self->data)[31]);//first 32 bit
  printf("data[35] unsigned int = %d\n",(unsigned int*)(self->data)[35]);//second 32 bit
  printf("data[39] unsigned int = %d\n",(unsigned int*)(self->data)[39]);//first 32 bit
  printf("data[43] unsigned int = %d\n",(unsigned int*)(self->data)[43]);//second 32 bit
  printf("data[47] unsigned int = %d\n",(unsigned int*)(self->data)[47]);//first 32 bit
  printf("data[51] unsigned int = %d\n",(unsigned int*)(self->data)[51]);//second 32 bit
  printf("data[55] unsigned int = %d\n",(unsigned int*)(self->data)[55]);//first 32 bit
  printf("data[59] unsigned int = %d\n",(unsigned int*)(self->data)[59]);//second 32 bit
  printf("data[63] unsigned int = %d\n",(unsigned int*)(self->data)[63]);//first 32 bit
  printf("data[67] unsigned int = %d\n",(unsigned int*)(self->data)[67]);//second 32 bit
  printf("data[71] unsigned int = %d\n",(unsigned int*)(self->data)[71]);//first 32 bit
  printf("data[75] unsigned int = %d\n",(unsigned int*)(self->data)[75]);//second 32 bit
  printf("data[79] unsigned int = %d\n",(unsigned int*)(self->data)[79]);//first 32 bit
  printf("data[83] unsigned int = %d\n",(unsigned int*)(self->data)[83]);//second 32 bit
  printf("data[87] unsigned int = %d\n",(unsigned int*)(self->data)[87]);//first 32 bit
  printf("data[91] unsigned int = %d\n",(unsigned int*)(self->data)[91]);//second 32 bit
  printf("data[95] unsigned int = %d\n",(unsigned int*)(self->data)[95]);//first 32 bit
  printf("data[99] unsigned int = %d\n",(unsigned int*)(self->data)[99]);//second 32 bit
  printf("data[103] unsigned int = %d\n",(unsigned int*)(self->data)[103]);//first 32 bit
  printf("data[107] unsigned int = %d\n",(unsigned int*)(self->data)[107]);//second 32 bit
  printf("data[111] unsigned int = %d\n",(unsigned int*)(self->data)[111]);//first 32 bit
  printf("data[115] unsigned int = %d\n",(unsigned int*)(self->data)[115]);//second 32 bit
  printf("data[119] unsigned int = %d\n",(unsigned int*)(self->data)[119]);//first 32 bit
  printf("data[123] unsigned int = %d\n",(unsigned int*)(self->data)[123]);//second 32 bit
  printf("data[127] unsigned int = %d\n",(unsigned int*)(self->data)[127]);//first 32 bit

  printf("data[0] char = %u\n",self->data[0]);//second 32 bit
  printf("data[1] char = %u\n",self->data[1]);//second 32 bit
  printf("data[2] char = %u\n",self->data[2]);//second 32 bit
  printf("data[3] char = %u\n",self->data[3]);//second 32 bit
  printf("data[4] char = %u\n",self->data[4]);//second 32 bit
  printf("data[5] char = %u\n",self->data[5]);//second 32 bit
  printf("data[6] char = %u\n",self->data[6]);//second 32 bit
  printf("data[7] char = %u\n",self->data[7]);//second 32 bit
  printf("data[8] char = %u\n",self->data[8]);//second 32 bit
  printf("data[9] char = %u\n",self->data[9]);//second 32 bit
  printf("data[10] char = %u\n",self->data[10]);//second 32 bit
  printf("data[11] char = %u\n",self->data[11]);//second 32 bit
  printf("data[12] char = %u\n",self->data[12]);//second 32 bit
  printf("data[13] char = %u\n",self->data[13]);//second 32 bit
  printf("data[14] char = %u\n",self->data[14]);//second 32 bit
  printf("data[15] char = %u\n",self->data[15]);//second 32 bit
  printf("data[16] char = %u\n",self->data[16]);//second 32 bit
  printf("data[17] char = %u\n",self->data[17]);//second 32 bit
  printf("data[18] char = %u\n",self->data[18]);//second 32 bit
  printf("data[19] char = %u\n",self->data[19]);//second 32 bit
  printf("data[20] char = %u\n",self->data[20]);//second 32 bit
  printf("data[21] char = %u\n",self->data[21]);//second 32 bit
  printf("data[22] char = %u\n",self->data[22]);//second 32 bit
  printf("data[23] char = %u\n",self->data[23]);//second 32 bit
  printf("data[24] char = %u\n",self->data[24]);//second 32 bit
  printf("data[25] char = %u\n",self->data[25]);//second 32 bit
  printf("data[26] char = %u\n",self->data[26]);//second 32 bit
  printf("data[27] char = %u\n",self->data[27]);//second 32 bit
  printf("data[28] char = %u\n",self->data[28]);//second 32 bit
  printf("data[29] char = %u\n",self->data[29]);//second 32 bit
  printf("data[30] char = %u\n",self->data[30]);//second 32 bit
  printf("data[31] char = %u\n",self->data[31]);//second 32 bit

  printf("number of dimensions: %f\n",self->nd);
  printf("number of dimensions: %i\n",self->nd);
  printf("number of dimensions: %x\n",self->nd);
  printf("number of dimensions: %d\n",self->nd);

  if(self->nd > 0)
    {
      printf("dimensions[0] = %f\n",self->dimensions[0]);
      printf("dimensions[1] = %f\n",self->dimensions[1]);
      printf("strides[0] = %d\n",self->strides[0]);
      printf("strides[1] = %d\n",self->strides[1]);//not used if dim<2
    }
    int n, nd;
	...
	printf("Printing PyArrayObject 2:\n");
	printf("data[0] = %d\n",(unsigned int)(self->data[0]));//first 32 bit
	printf("data[1] = %d\n",(unsigned int)(self->data[4]));//second 32 bit
	printf("data[0] char = %d\n",self->data[0]);//second 32 bit
	printf("data[1] char = %d\n",self->data[1]);//second 32 bit
	printf("data[2] char = %d\n",self->data[2]);//second 32 bit
	printf("data[3] char = %d\n",self->data[3]);//second 32 bit
...
printf("arraymethods::array_setscalar(PyArrayObject *self, PyObject *args)\n");
    int n, nd;
    int ret = -1;
    PyObject *obj;
...
{
printf("arraymethods::array_cast(PyArrayObject *self, PyObject *args)\n");
...
{
printf("arraymethods::array_wraparray(PyArrayObject *self, PyObject *args)\n");
    PyObject *arr;
    PyObject *ret;
...
{
	printf("arraymethods::array_getarray(PyArrayObject *self, PyObject *args)\n");
...
{
	printf("arraymethods::array_copy(PyArrayObject *self, PyObject *args)\n");
...
{
printf("arraymethods::array_resize(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    PyArray_Dims newshape;
    PyObject *ret;
    int n;
    int refcheck = 1;
...
printf("arraymethods::array_repeat(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    PyObject *repeats;
    int axis=MAX_DIMS;
...
{
printf("arraymethods::array_choose(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    PyObject *choices;
    int n;
    PyArrayObject *out=NULL;
...
{
printf("arraymethods::array_sort(PyArrayObject *self, PyObject *args, PyObject *kwds)");
    int axis=-1;
    int val;
...
{
printf("arraymethods::array_argsort(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=-1;
    PyArray_SORTKIND which=PyArray_QUICKSORT;
...
{
printf("arraymethods::array_searchsorted(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
...
{
printf("arraymethods::_deepcopy_call(char *iptr, char *optr, PyArray_Descr *dtype, PyObject *deepcopy, PyObject *visit)\n");
...
{
printf("arraymethods::array_deepcopy(PyArrayObject *self, PyObject *args)\n");
    PyObject* visit;
    char *optr;
    PyArrayIterObject *it;
...
{
printf("arraymethods::_getlist_pkl(PyArrayObject *self)");
    PyObject *theobject;
...
{
printf("arraymethods::_setlist_pkl(PyArrayObject *self, PyObject *list)");
    PyObject *theobject;
    PyArrayIterObject *iter=NULL;
...
{
printf("arraymethods::array_reduce(PyArrayObject *self, PyObject *args)\n");
...
{
printf("arraymethods::array_setstate(PyArrayObject *self, PyObject *args)\n");
    PyObject *shape;
...
{
printf("arraymethods::PyArray_Dump(PyObject *self, PyObject *file, int protocol)\n");
    PyObject *cpick=NULL;
    PyObject *ret;
...
{
printf("arraymethods::PyArray_Dumps(PyObject *self, int protocol)\n");
    PyObject *cpick=NULL;
    PyObject *ret;
    if (protocol < 0) protocol = 2;
...
{
printf("arraymethods::array_dump(PyArrayObject *self, PyObject *args)\n");
    PyObject *file=NULL;
    int ret;
...
{
printf("arraymethods::array_dumps(PyArrayObject *self, PyObject *args)\n");
...
{
printf("arraymethods::array_transpose(PyArrayObject *self, PyObject *args)\n");
...
{
printf("arraymethods::_get_type_num_double(PyArray_Descr *dtype1, PyArray_Descr *dtype2)\n");
    if (dtype2 != NULL)
...
{
printf("arraymethods::array_mean(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArray_Descr *dtype=NULL;
    PyArrayObject *out=NULL;
    int num;
...
{
printf("arraymethods::array_sum(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArray_Descr *dtype=NULL;
    PyArrayObject *out=NULL;
    int rtype;
...
{
printf("arraymethods::array_cumsum(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArray_Descr *dtype=NULL;
    PyArrayObject *out=NULL;
    int rtype;
...
{
printf("arraymethods::array_prod(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArray_Descr *dtype=NULL;
    PyArrayObject *out=NULL;
    int rtype;
...
{
printf("arraymethods::array_cumprod(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArray_Descr *dtype=NULL;
    PyArrayObject *out=NULL;
    int rtype;
...
{
printf("arraymethods::array_any(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArrayObject *out=NULL;
    static char *kwlist[] = {"axis", "out", NULL};
...
{
printf("arraymethods::array_all(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArrayObject *out=NULL;
    static char *kwlist[] = {"axis", "out", NULL};
...
{
printf("arraymethods::array_stddev(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArray_Descr *dtype=NULL;
    PyArrayObject *out=NULL;
    int num;
...
{
printf("arraymethods::array_variance(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyArray_Descr *dtype=NULL;
    PyArrayObject *out=NULL;
    int num;
...
{
printf("arraymethods::array_compress(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis=MAX_DIMS;
    PyObject *condition;
    PyArrayObject *out=NULL;
...
{
printf("arraymethods::array_nonzero(PyArrayObject *self, PyObject *args)\n");
    if (!PyArg_ParseTuple(args, "")) return NULL;
...
{
printf("arraymethods::array_trace(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
...
{
printf("arraymethods::array_clip(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
...
{
printf("arraymethods::array_conjugate(PyArrayObject *self, PyObject *args)\n");
...
{
printf("arraymethods::array_diagonal(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int axis1=0, axis2=1, offset=0;
...
{
printf("arraymethods::array_flatten(PyArrayObject *self, PyObject *args)\n");
    PyArray_ORDER fortran=PyArray_CORDER;
...
//---------------
 if (!PyArg_ParseTupleAndKeywords(args, kwargs, "Oi:nothing", kwlist,
				 &py_segs, &num_segs)) {//Can't we just skip the kwlist?
  printf("Damn! We're returning NULL, man...................................................................................\n");
  return NULL;
 }else
  {
    printf("Huttelihut..........................................................!\n");
...
// if (!PyArg_ParseTuple(args, "o", kwlist)) {//Can't we just skip the kwlist?
//   printf("Damn! We're returning NULL........................................................................... \
  //........\n");
  //   return NULL;
  // }
...
c_segs_array = (int *)segs_array->data;
 ...
 printf("Writing elememts out from the array:\n");
 printf("%d\n",c_segs_array[0]);
 printf("%d\n",c_segs_array[1]);
 printf("%d\n",c_segs_array[2]);
 /*
...
{
  printf("arraymethods::array_ravel(PyArrayObject *self, PyObject *args)\n");
  //Try to print out self and args here to see what there are...(just a suggestion...)
  ...
  //extern spe_program_handle_t spu_test;
  //Outcommented, because now we have another spu_test program lying in the root!
...
{
printf("arraymethods::array_round(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
    int decimals = 0;
    PyArrayObject *out=NULL;
...
{
printf("arraymethods::array_setflags(PyArrayObject *self, PyObject *args, PyObject *kwds)\n");
...
{
printf("arraymethods::array_newbyteorder(PyArrayObject *self, PyObject *args))\n");
