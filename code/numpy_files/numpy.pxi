...
cdef extern from "numpy/arrayobject.h":
	...
	cdef char **blockData
	cdef unsigned int numberOfBlocks
	cdef unsigned int numberOfBlocksXDim
	cdef unsigned int numberOfBlocksYDim
	cdef unsigned int blockSize
	cdef unsigned int size_in_bytes
	cdef unsigned int paddingx
	cdef unsigned int paddingy
	cdef unsigned int slice_type
	cdef unsigned int slice_value
