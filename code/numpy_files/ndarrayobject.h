...
typedef struct
{
  ...
  unsigned int slice_type;//0:no slice, 1:row slice, 2:col slice
  unsigned int slice_value;//row/col. This is used to determine a single row/col that is sliced out of the matrix.
