...
{
  //printf("Inside CreateSPEThread\n");
  //printf("yihr2........................myarg inside CreateSPEThread is: %x\n",myarg);
  //printf("Before calling spe_sontext_create in libppu.c\n");

	// create SPE context
    if ( ( spedata->spe_ctx = spe_context_create ( 0, NULL ) ) == NULL )
	{
	  //printf("Before printing a perror\n");
		perror ( "Failed creating context" );
        return -1;
	}
    //printf("before spe_program_load in libppu.c\n");
    ...
    //printf("After program load in libppu.h\n");
    ...
    //printf("Before returning in createspethread\n");
    return 1;
}
